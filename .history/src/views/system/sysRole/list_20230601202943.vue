      ...
      <el-form label-width="70px" size="small">
        ...
        <el-row style="display: flex">
          ...
          <el-button icon="el-icon-refresh" size="mini" @click="resetData"
            >重置</el-button
          >
          <el-button type="success" icon="el-icon-plus" size="mini" @click="edit()"
        >添 加</el-button
      >
  ...
  methods: {
    ...
    saveOrUpdate(){
      if(this.sysRole.id==null && this.sysRole.id == undefined){
        this.save(this.sysRole)
      }else{
        this.update(this.sysRole)
      }
    },
    //修改角色信息
    update(){
    ...
    handleSelectionChange(selection){
      ...
      console.log(this.multipleSelection+"llll");
    }
  },
};
</script>